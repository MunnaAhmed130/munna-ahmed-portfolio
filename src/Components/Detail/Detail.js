...
const details = ({ details }) => {
  return (
    <div>
      <Row className="details-row g-4">
        <Col xl={4} md={6} sm={12} className="project-demo-col">
          <div className="project-demo-container">
            <a
              href={details.project_demo_1}
              target="_blank"
              rel="noopener noreferrer"
              alt=""
            >
              <img
                src={details.project_demo_1}
        ...
        <Col xl={4} md={6} sm={12} className="project-demo-col">
          <div className="project-demo-container">
            <a
              href={details.project_demo_2}
              target="_blank"
              rel="noopener noreferrer"
              alt=""
            >
              <img
                src={details.project_demo_2}
                className="project-demo"
                alt=""
              />
            </a>
        ...
        <Col xl={4} md={12} sm={12} className="project-demo-col">
          <div className="project-demo-container">
            <a
              href={details.project_demo_3}
              target="_blank"
              rel="noopener noreferrer"
              alt=""
            >
              <img
                src={details.project_demo_3}
                className="project-demo"
                alt=""
              />
            </a>
      ...
      <div>
        <a
          href={details.github_client_repo}
          className=" link-btn"
          target="_blank"
          rel="noopener noreferrer"
          alt=""
        ...
        <a
          href={details.github_server_repo}
          className=" link-btn"
          target="_blank"
          rel="noopener noreferrer"
          alt=""
